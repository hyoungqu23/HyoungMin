...
![Clarity-Homepage.png](/images/posts/clarity-tracking-tools_clarity-homepage.png)

우선 [Microsoft Clarity 홈페이지](https://clarity.microsoft.com/)에 접속하여 로그인을 한 뒤, 시작 버튼을 누르면 새로운 프로젝트를 생성할 수 있다.

![New-Clarity-Project.png](/images/posts/clarity-tracking-tools_new-clarity-project.png)
...
![Untitled](/images/posts/clarity-tracking-tools_clarity-tour.png)

# 레코딩

![Clarity-Recording.png](/images/posts/clarity-tracking-tools_clarity-recording.png)

# 대시보드 기능

![Clarity-Dashboard.png](/images/posts/clarity-tracking-tools_clarity-dashboard.png)

# 히트맵, 스크롤맵, 섹션맵

![Clarity-Heatmap.png](/images/posts/clarity-tracking-tools_clarity-heatmap.png)

![Clarity-ScrollMap.png](/images/posts/clarity-tracking-tools_clarity-scrollmap.png)

![Clarity-SectionMap.png](/images/posts/clarity-tracking-tools_clarity-sectionmap.png)
