...
![Google SEO 기본 가이드, 검색 결과에서 시선을 끄는 제목 링크와 스니펫 작성하기](https://developers.google.com/search/docs/images/blank-title-link.png?hl=ko)
...
![Google SEO 기본 가이드, 메타 설명 태그 사용하기](https://developers.google.com/search/docs/images/blank-snippet.png?hl=ko)
