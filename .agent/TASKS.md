...
### 11.2 라이트/다크 모드 테마 변경 기능 ✅ (2025. 11. 13. 16:30:00)
...
### 11.4 Footer 컴포넌트 ✅ (2025. 11. 13. 17:30:00)
...
### 11.5 공유하기 기능 ✅ (2025. 11. 13. 16:50:00)
...
### 11.7 접근성 & 키보드 단축키 ✅ (2025. 11. 14. 09:30:00)
...
- [x] 헤더: Skip link 동작 확인, 네비게이션 메뉴 표시 (2025. 11. 13. 16:11:59)
- [x] 다크모드: 테마 토글 버튼 클릭 시 라이트/다크 모드 전환, 페이지 새로고침 시 테마 유지 (2025. 11. 13. 16:30:00)
- [x] 목차: 포스트 페이지에 Sticky 목차 표시, 클릭 시 해당 섹션으로 스크롤 이동 (2025. 11. 13. 16:11:59)
- [x] Footer: 모든 페이지 하단에 Footer 표시 (2025. 11. 13. 17:30:00)
- [x] 공유하기: 링크 복사 및 LinkedIn 공유 동작 확인 (2025. 11. 13. 16:50:00)
- [x] 접근성: Skip link 키보드 접근, 모든 버튼 aria-label 확인, 스크린 리더 테스트 (2025. 11. 14. 09:30:00)
- [x] 키보드 단축키: (선택) t(테마 토글), g(맨 위) 동작 확인 (2025. 11. 14. 09:30:00)
...
- [x] SEO 최적화 및 추가 기능 (2025. 01. 13.)
  ...
  - [x] 읽기 진행도 표시 (2025. 01. 13.)
- [ ] UI/UX 컴포넌트 및 기능
  - [x] 헤더 컴포넌트 (Skip link 포함) (2025. 11. 13. 16:11:59)
  - [x] 라이트/다크 모드 테마 변경 기능 (2025. 11. 13. 16:30:00)
  ...
  - [x] 접근성 & 키보드 단축키 (Skip link, aria-label, t/g 단축키) (2025. 11. 14. 09:30:00)
