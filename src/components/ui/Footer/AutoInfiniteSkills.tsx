import { INFORMATION, SKILLS } from '@/src/assets/constants';

const INFINITE_CAROUSEL_ITEMS = INFORMATION.concat(SKILLS);

const AutoInfiniteSkills = () => {
  return (
    <section className='relative mx-auto w-[1608.73px] h-14 overflow-x-hidden'>
      <div className='absolute z-10 w-[calc(100vw+24px)] min-[1610px]:w-[calc(100%+24px)] -left-3 -right-3 h-full bg-gradient-to-r from-secondary-500 from-[1%] via-transparent to-[99%] to-secondary-500' />
...
export default AutoInfiniteSkills;
